...
const PACKAGES: Record<string, { label: string; price: number | null; duration: string; servings: string; hours: string }> = {
  ...
  "Party Pack":   { label: "Party Pack",                  price: 225,  duration: "~30 min",      servings: "Up to 30 snoballs",  hours: "" },
  "Block Party":  { label: "Block Party",                 price: 350,  duration: "~1 hour",      servings: "Up to 60 snoballs",  hours: "" },
